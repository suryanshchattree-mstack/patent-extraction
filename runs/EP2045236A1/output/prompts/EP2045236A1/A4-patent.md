...
**Input:** `input/EP2045236A1-biblio.json`, the abstract and claims, and a rollup
computed from the other three artifacts
**Runs:** once.

Bibliographic fields are NOT produced by this prompt. They come from
`input/EP2045236A1-biblio.json`, which was scraped from Google Patents, and are
...
PATENT_ID: `EP2045236A1`

TITLE (zh): `Thermodynamisch stabile Kristallmodifikation von 2-({2-Chlor-4-(methylsulfonyl)-3-[(2,2,2-trifluorethoxy)methyl]phenyl}carbonyl)cyclohexan-1,3-dion`
TITLE (en): `Thermodynamically stable crystal modification of 2-({2-chloro-4-(methylsulfonyl)-3-[(2,2,2-trifluoroethoxy)methyl]phenyl}carbonyl)cyclohexane-1,3-dione`
