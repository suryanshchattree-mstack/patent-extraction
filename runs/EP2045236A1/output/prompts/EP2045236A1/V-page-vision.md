...
This pass replaces OCR. EP2045236A1 does carry a text layer, 47,791 characters across 23 pages, so the prose can be read without this pass. It runs anyway because the information that matters most is
