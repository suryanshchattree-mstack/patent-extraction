...
This pass replaces OCR. CN109678767A does carry a text layer, 10,750 characters across 11 pages, so the prose can be read without this pass. It runs anyway because the information that matters most is
