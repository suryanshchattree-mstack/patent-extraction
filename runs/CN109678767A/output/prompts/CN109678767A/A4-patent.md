...
**Input:** `input/CN109678767A-biblio.json`, the abstract and claims, and a rollup
computed from the other three artifacts
**Runs:** once.

Bibliographic fields are NOT produced by this prompt. They come from
`input/CN109678767A-biblio.json`, which was scraped from Google Patents, and are
...
PATENT_ID: `CN109678767A`

TITLE (zh): `一种除草剂环磺酮的合成工艺`
TITLE (en): `Synthesis process for the herbicide tembotrione`
