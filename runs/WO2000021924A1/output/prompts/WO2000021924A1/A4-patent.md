...
**Input:** `input/WO2000021924A1-biblio.json`, the abstract and claims, and a rollup
computed from the other three artifacts
**Runs:** once.

Bibliographic fields are NOT produced by this prompt. They come from
`input/WO2000021924A1-biblio.json`, which was scraped from Google Patents, and are
...
PATENT_ID: `WO2000021924A1`

TITLE (zh): `{TITLE_ZH}`
TITLE (en): `Benzoylcyclohexandiones, method for the production and use thereof as herbicides and plant growth regulators`
