...
**Input:** `input/US20100041557A1-biblio.json`, the abstract and claims, and a rollup
computed from the other three artifacts
**Runs:** once.

Bibliographic fields are NOT produced by this prompt. They come from
`input/US20100041557A1-biblio.json`, which was scraped from Google Patents, and are
...
PATENT_ID: `US20100041557A1`

TITLE (zh): `{TITLE_ZH}`
TITLE (en): `Crystalline forms of 2-[2-chloro-4-methylsulfonyl-3-(2,2,2-trifluoroethoxymethyl)benzoyl]cyclohexan-1,3-dione`
