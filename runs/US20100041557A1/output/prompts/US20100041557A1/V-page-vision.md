...
This pass replaces OCR. US20100041557A1 does carry a text layer, 77,178 characters across 15 pages, so the prose can be read without this pass. It runs anyway because the information that matters most is
