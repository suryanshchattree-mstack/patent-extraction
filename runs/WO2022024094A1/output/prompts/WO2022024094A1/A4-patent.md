...
**Input:** `input/WO2022024094A1-biblio.json`, the abstract and claims, and a rollup
computed from the other three artifacts
**Runs:** once.

Bibliographic fields are NOT produced by this prompt. They come from
`input/WO2022024094A1-biblio.json`, which was scraped from Google Patents, and are
...
PATENT_ID: `WO2022024094A1`

TITLE (zh): `{TITLE_ZH}`
TITLE (en): `Process for preparation of mesotrione and its intermediates`
