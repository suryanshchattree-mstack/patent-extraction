...
This pass replaces OCR. CN111440099B does carry a text layer, 4,254 characters across 10 pages, so the prose can be read without this pass. It runs anyway because the information that matters most is
