...
**Input:** `input/CN111440099B-biblio.json`, the abstract and claims, and a rollup
computed from the other three artifacts
**Runs:** once.

Bibliographic fields are NOT produced by this prompt. They come from
`input/CN111440099B-biblio.json`, which was scraped from Google Patents, and are
...
PATENT_ID: `CN111440099B`

TITLE (zh): `一种环磺酮产品的纯化方法`
TITLE (en): `Purification method for a tembotrione product`
