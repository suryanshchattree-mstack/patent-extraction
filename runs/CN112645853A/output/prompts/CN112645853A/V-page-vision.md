...
This pass replaces OCR. CN112645853A does carry a text layer, 21,576 characters across 20 pages, so the prose can be read without this pass. It runs anyway because the information that matters most is
