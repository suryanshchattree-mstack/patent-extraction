...
**Input:** `input/CN112645853A-biblio.json`, the abstract and claims, and a rollup
computed from the other three artifacts
**Runs:** once.

Bibliographic fields are NOT produced by this prompt. They come from
`input/CN112645853A-biblio.json`, which was scraped from Google Patents, and are
...
PATENT_ID: `CN112645853A`

TITLE (zh): `一种2-氯-3-烷氧基甲基-4-甲磺酰基苯甲酸的制备方法`
TITLE (en): `Preparation method for 2-chloro-3-alkoxymethyl-4-methylsulfonylbenzoic acid`
